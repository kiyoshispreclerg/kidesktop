...
int main(int argc, char **argv)
{
    ...
    while (wm.running) {
        ...
        /* ...and while a window from another desktop is being held up to
         * be photographed (client.h's client_hold). */
        client_run_holds();
        int hold_in = client_hold_timeout_ms();
